      ...
      <div className="flex items-end gap-3 max-w-3xl mx-auto">
        <div className="flex-1 relative">
          <Textarea
            ...
            rows={1}
            className="min-h-[44px] max-h-[160px] resize-none rounded-xl border-border bg-background focus-visible:ring-primary text-sm pr-4 py-3"
          />
        </div>
        {isStreaming ? (
          <Button
            ...
            size="icon"
            onClick={onStop}
            className="h-11 w-11 rounded-xl border-destructive/30 text-destructive hover:bg-destructive/10 hover:text-destructive flex-shrink-0"
          >
