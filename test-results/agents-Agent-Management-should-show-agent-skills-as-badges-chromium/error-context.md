...
- Name: agents.spec.ts >> Agent Management >> should show agent skills as badges
- Location: tests/e2e/agents.spec.ts:87:7
...
Locator: getByText(/strategy|coding|debugging/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/strategy|coding|debugging/i).first()
