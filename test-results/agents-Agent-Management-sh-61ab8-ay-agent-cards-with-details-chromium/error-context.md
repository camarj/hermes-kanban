...
- Name: agents.spec.ts >> Agent Management >> should display agent cards with details
- Location: tests/e2e/agents.spec.ts:22:7
...
Locator: locator('[data-testid="agent-card"]').first()
Expected: visible
Timeout: 5000ms
