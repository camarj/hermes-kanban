...
- Name: kanban.spec.ts >> Kanban Board >> should display kanban board with 6 columns
- Location: tests/e2e/kanban.spec.ts:9:7
...
Locator: getByRole('heading', { name: 'Triage' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Triage' })
