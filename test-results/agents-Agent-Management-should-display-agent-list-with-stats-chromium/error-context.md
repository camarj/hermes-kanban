...
- Name: agents.spec.ts >> Agent Management >> should display agent list with stats
- Location: tests/e2e/agents.spec.ts:8:7
...
Locator: getByRole('heading', { name: /ai agents/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /ai agents/i })
