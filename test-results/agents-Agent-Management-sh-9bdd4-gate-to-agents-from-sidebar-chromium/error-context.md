...
- Name: agents.spec.ts >> Agent Management >> should navigate to agents from sidebar
- Location: tests/e2e/agents.spec.ts:97:7
...
Call log:
  - waiting for getByRole('link', { name: /^agents$/i })
