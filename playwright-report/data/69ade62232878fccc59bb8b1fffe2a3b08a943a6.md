...
- Name: organization.spec.ts >> Organization Management >> should switch between organizations
- Location: tests/e2e/organization.spec.ts:57:7
...
Call log:
  - waiting for getByText('Acme Corporation')
