...
- Name: organization.spec.ts >> Organization Management >> should create organization successfully
- Location: tests/e2e/organization.spec.ts:24:7
...
Call log:
  - waiting for getByLabel(/organization name/i)
