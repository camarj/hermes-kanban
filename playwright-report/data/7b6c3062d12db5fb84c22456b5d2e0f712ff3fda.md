...
- Name: agents.spec.ts >> Agent Management >> should show error for duplicate hermes profile
- Location: tests/e2e/agents.spec.ts:52:7
...
Call log:
  - waiting for getByRole('button', { name: /new agent/i })
